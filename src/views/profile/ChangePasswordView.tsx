  ...
  return (
    <>
      <div className="mx-auto max-w-3xl">
        <h1 className="text-4xl font-black text-neutral-600">
          Cambiar Password
        </h1>
        ...
        <form
          ...
          className=" mt-14 space-y-5 bg-orange-50 shadow-lg p-10 rounded-lg border-2 border-teal-300"
          noValidate
        >
          ...
          <div className="mb-5 space-y-3">
            <label
              ...
              className="tfont-normal text-neutral-600 text-2xl"
            >
              Repetir Password
            </label>
