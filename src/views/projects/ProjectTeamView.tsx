  ...
  if (data)
    return (
      <>
        ...
        <h2 className="text-5xl text-neutral-700 font-black mt-14">
          Miembros actuales
        </h2>
        {data.length ? (
          <ul
            role="list"
            className="divide-y divide-teal-300 border-2 border-teal-300 mt-10 bg-orange-50 shadow-lg rounded-md"
          >
            {data?.map((member) => (
              <li
                key={member._id}
